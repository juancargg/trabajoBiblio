...
//Reutilizacion de alta.php con modificaciones por contar con un formulario
            ...
            <div class="row mt-3 justify-content-md-center">
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <!--Generado con un Bootstrap snippet: bs5-form-input -->
                            <div class="mb-3">
                                <label for="identificador" class="form-label">Identificador</label>
                                <input type="number" class="form-control" name="identificador" id="identificador" autofocus placeholder="Introduce Id" required value="<?php echo $registro[0]; ?>" />
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <label for="imagen" class="form-label">Imagen antigua</label>
